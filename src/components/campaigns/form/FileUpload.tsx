...
const FileUpload = ({ onFileSelect }: FileUploadProps) => (
  <div className="mt-6">
    <label className="block">
      <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Upload CSV or Excel File</span>
      <div className="mt-1 border-2 border-dashed border-slate-200 dark:border-dark-700 rounded-xl p-8 text-center hover:border-primary-400 transition-colors">
        ...
        <label htmlFor="file-upload" className="cursor-pointer">
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">CSV, Excel up to 10MB</p>
          </div>
        </label>
      </div>
    </label>
