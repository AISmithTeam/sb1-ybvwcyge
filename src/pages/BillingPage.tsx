        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium text-slate-800 dark:text-white">$456.78</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-slate-600 dark:text-slate-400">Language Models</span>
              <span className="font-medium text-slate-800 dark:text-white">$567.89</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-slate-600 dark:text-slate-400">Text-to-Speech</span>
              <span className="font-medium text-slate-800 dark:text-white">$209.89</span>
            </div>
            <div className="pt-4 border-t border-slate-200 dark:border-dark-700">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-slate-800 dark:text-white">$1,234.56</span>
              </div>
            </div>
          </div>
        </Card>
